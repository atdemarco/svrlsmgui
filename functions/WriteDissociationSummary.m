function WriteDissociationNarrative(handles)
    assignin('base','handles',handles)
    % here parmsfile is the dissocation information...
...
% show lesion coverage for main1 and main2 
% show coverage loss and number of voxels lost

% show main effect of behavior 1 and behavior 2

% show place where main 1 > main 2

% show place where main 2 > main 1 (disjunction)

% show place where main 1 == main 2 (conjunction)
