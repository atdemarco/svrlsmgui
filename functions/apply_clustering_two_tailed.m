function [variables,ctab,T,survivingbetavals,clusterthresh] = apply_clustering_two_tailed(parameters,variables,real_beta_map_vol,sorted_clusters)
    error('not fully implemented yet after core refactoring')
    ...
    svrlsmgui_write_vol(variables.vo, two_tailed_beta_out_vol);
    ...
    svrlsmgui_write_vol(variables.vo, abs(two_tailed_beta_out_vol));
    ...
    variables.vo.fname = fullfile(variables.output_folder.clusterwise,'Thresholded by cluster size (betas).nii');
